<template>
  <sds-container class="components p-0">
    <sds-layout-sidebar>
      <aside slot="sidebar" class="bg-static-gray-900 border-r hidden md:block">
          ...
          <section slot="content">
            ...
            <sds-container class="bg-gray-200 h-64">
              <sds-layout-stacked>
                ...
                <main slot="content" class="border-dashed border">Content</main>
                <footer slot="footer" class="border-dashed border">
                  Footer
                </footer>
              </sds-layout-stacked>
            </sds-container>
          ...
          <section slot="content">
            ...
            <sds-container class="bg-gray-200">
              <sds-layout-sidebar>
                ...
                <main slot="content" class="border-dashed border">Content</main>
                <footer slot="sidebar-right" class="border-dashed border">
                  Sidebar-right
                </footer>
              </sds-layout-sidebar>
            </sds-container>
